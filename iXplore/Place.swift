...
class Place: NSObject, MKAnnotation, NSCoding  {
    ...
    func encodeWithCoder(aCoder: NSCoder) {
        aCoder.encodeObject(NSNumber(double: self.coordinate.latitude), forKey: "latitude")
        aCoder.encodeObject(NSNumber(double: self.coordinate.longitude), forKey: "longitude")
